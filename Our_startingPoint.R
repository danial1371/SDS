...
handmade.em <- function(y,plot_flag = T){ #plot_flag = T -> make a plot
  ...
  sigma = floor(runif(k,1,sqrt(var(faithful$waiting))))
...
# choose random values in our range with a uniform distribution
